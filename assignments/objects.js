...
console.log(internTwo.speak());             // putting internTwo.speak ONLY returns the function - parentheses matter
...
const parent = {
  ...
  age: 70,
  child: {
    name: "George", age: "50", grandchild: {name: "Sam", age: 50, speak: function () {return `Hello, my name is ${this.name}!` }},
     speak: function () {
      return `Hello, my name is ${this.name}!` }},
  speak: function(){
    return `Hello, my name is ${this.name}!`
